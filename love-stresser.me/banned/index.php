...
if (isset($_COOKIE['LS_ASP']) && !empty($_COOKIE['LS_ASP'])) {
    ...
    $stmt = $conn->prepare("SELECT banned FROM users WHERE token = ?");
    ...
    $stmt = $conn->prepare("SELECT ban_reason FROM users WHERE token = ?");
    $stmt->bind_param("s", $token);
    $stmt->execute();
    ...
    $ban_reason = $ban_reason ?: 'No reason provided';
...
<html class="no-js" lang="en-US">
  ...
  <script>console.log = function(){ };</script>
    <meta charset="UTF-8" />
    <title>LoveStresser - BANNED</title>
				...
				<div class="elementor-widget-container">
					...
					<div class="container">
						...
						<div class="hero__content">
							...
							<h1 id="title" title="">
								<span class="stroke-double">YOU'VE BEEN BANNED!</span>
							</h1>
							</div>
							<div class="hero__subtitle">
							<p>
								Uh oh! It looks like you did something wrong because you're banned from the entire website! If you believe this was a mistake, you can still contact us.
							</p>
							<br></br>
							<p>
								Ban Reason: <?php echo htmlspecialchars($ban_reason); ?>
							</p>
							</div>
							<div class="hero__buttons">
							<div class="cta-button">
								<a href="<?php echo $ban_server_full_link ?>">Contact Us</a>
							</div>
							<div class="cta-button">
